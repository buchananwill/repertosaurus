 ...
 *
 * The app is booted against a broken database — the whole tree, `RepertaurusApp` and all, not
...
class RecoveryScreenTest {
    ...
    fun anUnreadableDatabaseShowsRecoveryWithBothActions() {
        ...
        compose.onNodeWithText("Repertaurus can't open your database").assertIsDisplayed()
    }
    ...
    private fun show(name: String): SessionViewModel {
        ...
        compose.setContent { MaterialTheme { RepertaurusApp(model) } }
