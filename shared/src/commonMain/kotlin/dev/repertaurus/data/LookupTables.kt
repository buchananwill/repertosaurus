 ...
 * [RepertaurusRepository] is exactly the kind of duplication decision 15's "one abstraction"
 ...
 * helper lived on `RepertaurusRepository`, which E30 took past its own deferral trigger at
 ...
 * of the split its own piece of work, because promoting `RepertaurusRepository.Performer` and
