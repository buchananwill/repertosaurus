...
class SessionStateTest {
    ...
    fun chipsFollowTheSeedOrderNotTheAlphabet() {
        val chips = SessionInstruments.chips(
            listOf(
                RepertosaurusRepository.Instrument("i-backing", "backing vocal"),
                RepertosaurusRepository.Instrument("i-bass", "bass"),
                RepertosaurusRepository.Instrument("i-guitar", "guitar"),
                RepertosaurusRepository.Instrument("i-keys", "keys"),
                RepertosaurusRepository.Instrument("i-vocal", "vocal"),
            ),
        )
        assertEquals(
    ...
    fun anInstrumentTheUserAddsStillAppears() {
        val chips = SessionInstruments.chips(
            listOf(
                RepertosaurusRepository.Instrument("i-mandolin", "mandolin"),
                RepertosaurusRepository.Instrument("i-vocal", "vocal"),
                RepertosaurusRepository.Instrument("i-accordion", "accordion"),
            ),
        )
