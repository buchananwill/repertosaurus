...
public const val DATABASE_NAME: String = "repertosaurus.db"
 ...
 */
public fun createDatabase(context: Context, name: String = DATABASE_NAME): RepertosaurusDatabase =
    RepertosaurusDatabase(createDriver(context, name))
...
public fun createDriver(context: Context, name: String = DATABASE_NAME): AndroidSqliteDriver =
    AndroidSqliteDriver(
        schema = RepertosaurusDatabase.Schema,
        context = context,
        name = name,
        callback = object : AndroidSqliteDriver.Callback(RepertosaurusDatabase.Schema) {
